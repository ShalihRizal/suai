                                            ...
                                            <td width="15%">
                                                @if ($machine->machine_id > 0)
                                                    <a href="javascript:void(0)"
                                                        ...
                                                        data-id="{{ $machine->machine_id }}" data-toggle="tooltip"
                                                        data-placement="top" title="Ubah">
                                                        <i data-feather="edit" width="16" height="16"></i>
                                                    </a>
                                                    <a href="javascript:void(0)"
                                                        class="btn btn-icon btn-danger text-white btnDelete"
                                                        data-url="{{ url('machine/delete/' . $machine->machine_id) }}"
                    ...
                    <div class="modal-body">
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label">Carname <span class="text-danger">*</span> </label>
                                        <select class="form-control" name="carname_id" id="carname_id">
                                            <option value="">- Pilih Carname -</option>
