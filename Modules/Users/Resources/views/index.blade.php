                            ...
                            <tr class="part-row" data-category="{{ $user->group_id }}">
                                ...
                                <td width="15%">
                                    ...
                                    <a href="javascript:void(0)"
                                        ...
                                        data-url="{{ url('users/delete/' . $user->user_id) }}"
        ...
        <div class="modal-content">
            ...
            <form action="{{ url('users/store') }}" method="POST" id="addForm">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="user_username"
                                        id="user_username" placeholder="Masukan username pengguna" required
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="user_email" id="user_email"
                                        placeholder="Masukan email pengguna" value="{{ old('user_email') }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control mb-2" name="user_password_old"
                                        ...
                                        value="{{ old('user_password_old') }}" required>
                ...
                <div class="modal-footer">
                    <button type="button" class="text-white btn btn-danger cancel" data-dismiss="modal"
                        data-toggle="collapse" data-target="#toggle-collapse">Batal</button>
