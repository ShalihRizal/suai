                    ...
                    <div class="btn-group" style="height: 40px;">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <select class="form-control" name="car_model" id="custom-filter" style="height: 100%; margin-left: 25px;">
...
<script>
    function downloadFile() {
        ...
        var fileUrl = 'https://drive.google.com/uc?export=download&id=110YCpN7OuNKTvpzbRsMYJ-s94woUyarT';
