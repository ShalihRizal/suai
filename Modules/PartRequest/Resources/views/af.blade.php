    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header w-100">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="h3">Part Request - Assembly Fixture</h3>
                        {{ date('Y-m-d') }}
                    </div>
                    <div class="col-md-6">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <form method="GET" action="{{ url('partrequest/af') }}">
                        ...
                        <tbody>
                            ...
                            <tr class="part-row" data-category="{{ $partrequest->part_req_number }}" data-created-at="{{ $partrequest->created_at }}">
                                ...
                                <td width="15%">
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-icon btn-danger text-white btnDelete" data-url="{{ url('partrequest/af/delete/' . $partrequest->part_req_id) }}" data-toggle="tooltip" data-placement="top" title="Hapus">
...
<div class="modal fade addModal" tabindex="-1" role="dialog" style="margin-top: 1%;" id="addModal">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ url('partrequest/af/store') }}" method="POST" id="addForm" enctype="multipart/form-data">
                @csrf
...
<script type="text/javascript">
    $('.btnAdd').click(function() {
        ...
        $('#wire_crimper').val('');
        $('#other').val('');
        $('.addModal form').attr('action', "{{ url('partrequest/af/store') }}");
        $('.addModal .modal-title').text('Tambah Part Request - Assembly Fixture');
        $('.addModal').modal('show');
    })
