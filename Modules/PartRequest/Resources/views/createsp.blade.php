    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h1 class="h3">Part Request - Sparepart Machine</h1>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ url('partrequest/sp/store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // Tambahkan konfigurasi select2 untuk field part
