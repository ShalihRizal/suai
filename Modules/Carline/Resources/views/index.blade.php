        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="addData">
                        <a href="javascript:void(0)" class="btn btn-danger btnBulkDelete text-white mb-3">
                            <i data-feather="trash-2" width="16" height="16" class="me-2"></i>
                            Bulk Delete
                        </a>
                    </div>
                        ...
                        <table id="table-data" class="table card-table table-vcenter text-nowrap table-data">
                            ...
                            <tbody>
                                @if (sizeof($carlines) == 0)
                                    <tr>
                                        <td colspan="25" align="center">Data kosong</td>
                                    </tr>
                                @else
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" style="vertical-align: middle;">
                                                <div class="form-check d-flex justify-content-center align-items-center">
                                                    <input class="form-check-input checkbox" type="checkbox" style="width: 16px; height: 16px;" value="{{ $carline->carline_id }}">
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
    ...
    <script type="text/javascript">
        ...
        $('.btnBulkDelete').click(function() {
            ...
            if (selectedIds.length > 0) {
                var url = "{{ route('carline.bulkDelete') }}";
