        ...
        <div class="card">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div class="card-body">
                        <div class="arrow-right">
                            <a href="{{route('af')}}" class="btn btn-success btnAdd text-white mb-3 d-block w-60">
                                <i data-feather="arrow-right" width="16" height="16" class="me-2"></i> Assembly Fixture
                            </a>
                        </div>
                        <div class="arrow-right">
                            <a href="{{route('cf')}}" class="btn btn-success btnAdd text-white mb-3 d-block w-60">
                                <i data-feather="arrow-right" width="16" height="16" class="me-2"></i> Checker Fixture
                            </a>
                        </div>
                        <div class="">
                            <a href="{{route('cd')}}" class="btn btn-success btnAdd text-white mb-3 d-block w-60">
                                <i data-feather="arrow-right" width="16" height="16" class="me-2"></i> Crimping Dies
                            </a>
                        </div>
                        <div class="arrow-right">
                            <a href="{{route('sp')}}" class="btn btn-success btnAdd text-white mb-3 d-block w-60">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card-body">
                        <div class="addData">
                            <a href="{{route('hassto')}}" class="btn btn-success btnAdd text-white mb-3 d-block w-60">
                                <i data-feather="file-text" width="16" height="16" class="me-2"></i> Sudah STO
                            </a>
                        </div>
                        <div class="addData">
                            <a href="{{route('nosto')}}" class="btn btn-success btnAdd text-white mb-3 d-block w-60">
                                <i data-feather="file-text" width="16" height="16" class="me-2"></i> Belum STO
                            </a>
                        </div>
                        <div class="addData">
                            <a href="{{route('updateall')}}" class="btn btn-success btnReset text-white mb-3 d-block w-60">
