                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="addData">
                                                                <a href="javascript:void(0)"
                                                                    class="btn btn-success btnReset text-white mb-3"
                                                                    id="showModalButton">
                                                                    <i data-feather="x" width="16" height="16"
                                                                        class="me-2"></i>
                                                                    Reset
                                                                </a>
                                                            </div>
                                                                ...
                                                                <div class="form-group" hidden>
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label class="form-label">Part Category <span
                                                                                    class="text-danger">*</span>
                                                                            </label>
                                                                            <select class="form-control"
                                                                                name="part_category_id"
                                                                                id="part_category_id">
                                                                                <option value="">- Pilih Part
                                                                                    Category -</option>
                                                                                @if (sizeof($partcategories) > 0)
                                                                                    @foreach ($partcategories as $partcategory)
                                                                                        <option
                                                                                            value="{{ $partcategory->part_category_id }}">
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <div class="col-md-12 mb-3" hidden>
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control part_no"
                                                                    name="part_no" id="part_no" autofocus>
                                                                <div colspan="4" align="center">ㅤ</div>
                                                                >>>>>>> 742f2641ab68ceb2286a5a4e1710e0f36ff83c32
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <div class="modal fade addReset" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ url('stockopname/updateall') }}" method="GET" id="addForm">
                        @csrf
