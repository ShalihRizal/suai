...
<body class="light" style="background-image: url('{{ asset('img/background_login.jpg') }}'); background-size: cover;">
  ...
  <br>
  <div class="form-group mx-auto" style="background-color: white; width: 11.3%; text-align: center; border-radius: 10px; padding-top: 10px; height: 30px;">
    <label>SN: SUAI-DRI-02</label>
  </div>
