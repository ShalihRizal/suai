            ...
            foreach ($getMenus as $menu) {
                ...
                if (sizeof($getSubs) > 0) {
                    ...
                    foreach ($getSubs as $sub) {
                        ...
                        $active = Request::segment(1) == $sub->menu_url ? 'active' : '';
                    ...
                    $active = in_array(Request::segment(1), $subLinks) ? 'active' : '';
                    $show = in_array(Request::segment(1), $subLinks) ? 'show' : '';
                    ...
                    $active = Request::segment(1) == $menu->menu_url ? 'active' : '';
